...
const getUser = (users, userLogged) => users
  ?.filter((user) => user !== userLogged?.email)[0]

const ChatCardItems = ({ id, users, user, setUserChat, active }) => {
